...
if ($product['stock_type'] == 'multi') {

    echo '<script type="text/javascript">
        window.location.href = "./admin-panel.php?option=multi-stock-manage&&pid=' . $pid . '";
      </script>';
    exit;
}
...
<main class="container mt-0">
    ...
    <div class="category-form row">
        <div class="mb-3 col-md-5">
            <h4 class="mb-4 pb-3 border-bottom">Manage Stock</h4>
            <div class="row">
                <h5 class="mb-3"><b>Total Quantity : </b><?php echo $product['total_quantity'] . " " . $unit['unit_name'] ?></h5>
                ...
                <div class="update-product-variant">
                    ...
                    <form action=".././process/inventory/update-variant.php" method="POST" style="width : 80%">
                        ...
                        <div class="w-100 d-flex gap-2">
                            <a class="w-50" href="./admin-panel.php?option=stock-manage&&pid=<?php echo $variant['product_id'] ?>"><button type="button" class="cancel-btn btn btn-primary w-100 mt-4 float-end">Cancel</button></a>
        ...
        <div class="mb-3 col-md-7">
            <h3 class=" mb-4 pb-3 border-bottom">All Variants</h3>

            <div class="table-responsive" style="height: 90%; overflow-y:scroll">
                <table class="table table-bordered table-hover">
                    <thead class="table-dark">
                        <tr>
                            <th scope="col">Id</th>
                            <th scope="col" style="width: 35%;">Variant Name</th>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='./admin-panel.php?option=stock-manage&&pid=" . $row['product_id'] . "&&vid=" . $row['variant_id'] . "'><button class='update btn btn-primary '>Update</button></a>
                        <a href='.././process/inventory/delete-variant.php?vid=" . $row['variant_id'] . "&&pid=" . $row['product_id'] . "'><button class='delete btn btn-danger'>Delete</button></a>
                        </td>
                   </tr>";
                            }
                        } else {
